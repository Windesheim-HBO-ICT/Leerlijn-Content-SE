...
| ❌ | Mermaid | schrijfwijze/Mermaid.md | N/A | N/A | No taxonomie found in file. |
| ❌ | LateX | schrijfwijze/LateX.md | N/A | N/A | No taxonomie found in file. |
| ⚠️ | Schrijfwijze | schrijfwijze/Schrijfwijze.md | ib-19.2.Controlestructuur-Beslissingen-If-Else.OI<br>ib-19.3.Controlestructuur-Beslissingen-If-Else.OI | HBO-i/niveau-2<br>HBO-i/niveau-3<br>Implementatieproces<br>Bouwen softwaresysteem<br>Controlestructuur-Beslissingen-If-Else | Invalid dynamic link: `[[bestandsnaam]]`<br>Invalid dynamic link: `[[bestandsnaam]]` |
...
| ⚠️ | PI template | schrijfwijze/templates/PI template.md | "[taxco]" | N/A | Invalid taxonomie: "[taxco]" |
| ⚠️ | OI template | schrijfwijze/templates/OI template.md | "[taxco]" | N/A | Invalid taxonomie: "[taxco]" |
| ⚠️ | DT template | schrijfwijze/templates/DT template.md | "[taxco]" | N/A | Invalid taxonomie: "[taxco]" |
