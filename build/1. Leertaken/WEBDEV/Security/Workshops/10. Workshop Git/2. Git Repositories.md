...
>Bij het aanmaken van je nieuwe .NET project is het je vast opgevallen dat er veel extra bestanden zijn toegevoegd aan je commit. Deze bestanden horen meestal niet in de repository thuis, zoals tijdelijke bestanden of bestanden gegenereerd door je IDE. Dit kan voorkomen worden door een .gitignore bestand toe te voegen.
...
**Stap 1.1:** Voeg de standaard .gitignore regels voor een Visual Studio project toe. Dit zorgt ervoor dat tijdelijke en gegenereerde bestanden niet worden opgenomen in je commit. Je kunt een voorbeeld .gitignore voor Visual Studio vinden op de [.gitignore repository](https://github.com/github/gitignore/blob/main/VisualStudio.gitignore) of op [Toptal](https://www.toptal.com/developers/gitignore).
