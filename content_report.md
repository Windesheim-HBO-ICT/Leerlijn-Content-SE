...
| 🔨 | 1. Uitleg Constructor | 4. Csharp\Datatypen\Objecten\Constructor\1. Uitleg Constructor.md | ib-19.2.Constructors.OI<br>ib-19.3.Constructors.OI | HBO-i/niveau-2<br>HBO-i/niveau-3<br>Bouwen softwaresysteem<br>Constructors<br>Implementatieproces | Work-in-progress items gevonden: <br>-=INITIALISEREN=-<br>-=KLASSE=- |
...
| 🔨 | 1. Uitleg Enum | 4. Csharp\Datatypen\Enum\1. Uitleg Enum.md | ib-19.2.Enums.OI<br>ib-19.3.Enums.OI | HBO-i/niveau-2<br>HBO-i/niveau-3<br>Bouwen softwaresysteem<br>Enums<br>Implementatieproces | Work-in-progress items gevonden: <br>-=INTEGER=- |
| 🔨 | 1. Uitleg Events | 4. Csharp\Events\1. Uitleg Events.md | ib-19.2.Events-Delegates.OI<br>ib-19.3.Events-Delegates.OI | HBO-i/niveau-2<br>HBO-i/niveau-3<br>Bouwen softwaresysteem<br>Events-Delegates<br>Implementatieproces | Work-in-progress items gevonden: <br>-=TYPE=- |
...
| 🔨 | 1. Uitleg Generics | 4. Csharp\Generics\1. Uitleg Generics.md | ib-19.2.Generic-Type.OI<br>ib-19.3.Generic-Type.OI<br>ib-19.2.Generic-Methods.OI<br>ib-19.3.Generic-Methods.OI | HBO-i/niveau-2<br>HBO-i/niveau-3<br>Bouwen softwaresysteem<br>Generic-Methods<br>Generic-Type<br>Implementatieproces | Work-in-progress items gevonden: <br>-=INTERFACES=-<br>-=LIST=-<br>-=LINQ=- |
| 🔨 | 1. Uitleg Inheritance | 4. Csharp\Inheritance-Abstract-Classes\1. Uitleg Inheritance.md | ib-19.2.Inheritance-AbstractClasses.OI<br>ib-19.3.Inheritance-AbstractClasses.OI | HBO-i/niveau-2<br>HBO-i/niveau-3<br>Bouwen softwaresysteem<br>Implementatieproces<br>Inheritance-AbstractClasses | Work-in-progress items gevonden: <br>-=CLASS=-<br>-=POLYMORFISME=-<br>-=PROPERTY=-<br>-=KLASSEN=- |
| 🔨 | 1. Uitleg Long | 4. Csharp\Datatypen\Primitieve datatypen\Long\1. Uitleg Long.md | ib-19.2.Long.OI<br>ib-19.3.Long.OI | HBO-i/niveau-2<br>HBO-i/niveau-3<br>Bouwen softwaresysteem<br>Implementatieproces<br>Long | Work-in-progress items gevonden: <br>-=DECIMAL=- |
...
| 🔨 | 1. Uitleg Set | 4. Csharp\Datastructuren\Set\1. Uitleg Set.md | ib-19.2.Set.OI<br>ib-19.3.Set.OI | HBO-i/niveau-2<br>HBO-i/niveau-3<br>Bouwen softwaresysteem<br>Implementatieproces<br>Set | Work-in-progress items gevonden: <br>-=OEFENINGEN=- |
...
| 🔨 | 1. Uitleg Unsigned Long | 4. Csharp\Datatypen\Primitieve datatypen\Unsigned Long\1. Uitleg Unsigned Long.md | ib-19.2.ULong.OI<br>ib-19.3.ULong.OI | HBO-i/niveau-2<br>HBO-i/niveau-3<br>Bouwen softwaresysteem<br>Implementatieproces<br>ULong | Work-in-progress items gevonden: <br>-=DECIMAL=- |
...
| 🔨 | 3. Oefeningen Code-Smells | 4. Csharp\Code-Review\3. Oefeningen Code-Smells.md | ib-19.2.Code-review.DT<br>ib-19.3.Code-review.DT | HBO-i/niveau-2<br>HBO-i/niveau-3<br>Bouwen softwaresysteem<br>Code-review<br>Implementatieproces | Work-in-progress items gevonden: <br>-=SWITCH=-<br>-=POLYMORFISME=- |
...
| 🔨 | 3. Uitleg Constructor Chaining | 4. Csharp\Datatypen\Objecten\Constructor\3. Uitleg Constructor Chaining.md | ib-19.2.Constructors.OI<br>ib-19.3.Constructors.OI | HBO-i/niveau-2<br>HBO-i/niveau-3<br>Bouwen softwaresysteem<br>Constructors<br>Implementatieproces | Work-in-progress items gevonden: <br>-=SAMENVOEGENMETCONSTRUCTOROVERLOADING=-<br>-=KLASSE=-<br>-=INITIALISEREN=-<br>-=INITIALISEREN=- |
| 🔨 | 3. Uitleg Method Chaining | 4. Csharp\Datatypen\Objecten\Methodes\3. Uitleg Method Chaining.md | ib-19.2.Methods.OI<br>ib-19.3.Methods.OI | HBO-i/niveau-2<br>HBO-i/niveau-3<br>Bouwen softwaresysteem<br>Implementatieproces<br>Methods | Work-in-progress items gevonden: <br>-=SAMENVOEGENMETMETHODESOVERLOADING=- |
...
| ❌ | keepme | 3. Algoritmiek\keepme.md | N/A | N/A | Geen taxco gevonden |
...
| ⚠️ | 1. Introductie Juiceshop I | 9. Security\6. Workshop Juiceshop I\1. Introductie Juiceshop I.md | N/A | N/A | Bestand wordt genegeerd door ignore tag |
| ⚠️ | 1. Introductie Juiceshop II | 9. Security\7. Workshop Juiceshop II\1. Introductie Juiceshop II.md | N/A | N/A | Bestand wordt genegeerd door ignore tag |
| ⚠️ | 1. Introductie SAST | 9. Security\8. Workshop SAST\1. Introductie SAST.md | N/A | N/A | Bestand wordt genegeerd door ignore tag |
...
| ⚠️ | 1. Introductie ZAP | 9. Security\3. ZAP\Workshop\1. Introductie ZAP.md | N/A | N/A | Bestand wordt genegeerd door ignore tag |
...
| ⚠️ | 1. Wat is ZAP | 9. Security\3. ZAP\1. Wat is ZAP.md | N/A | N/A | Bestand wordt genegeerd door ignore tag |
...
| ⚠️ | 2. Hoe zit ZAP in elkaar | 9. Security\3. ZAP\2. Hoe zit ZAP in elkaar.md | N/A | N/A | Bestand wordt genegeerd door ignore tag |
...
| ⚠️ | 2. Workshop Juiceshop I | 9. Security\6. Workshop Juiceshop I\2. Workshop Juiceshop I.md | N/A | N/A | Bestand wordt genegeerd door ignore tag |
| ⚠️ | 2. Workshop Juiceshop II | 9. Security\7. Workshop Juiceshop II\2. Workshop Juiceshop II.md | N/A | N/A | Bestand wordt genegeerd door ignore tag |
| ⚠️ | 2. Workshop SAST | 9. Security\8. Workshop SAST\2. Workshop SAST.md | N/A | N/A | Bestand wordt genegeerd door ignore tag |
| ⚠️ | 2. Workshop ZAP | 9. Security\3. ZAP\Workshop\2. Workshop ZAP.md | N/A | N/A | Bestand wordt genegeerd door ignore tag |
...
| ⚠️ | 3. Hoe werkt ZAP | 9. Security\3. ZAP\3. Hoe werkt ZAP.md | N/A | N/A | Bestand wordt genegeerd door ignore tag |
...
| ⚠️ | 4. Aanvallen | 9. Security\3. ZAP\4. Aanvallen.md | N/A | N/A | Bestand wordt genegeerd door ignore tag |
...
| ✅ | 1. Introductie Git | 7. Git\2. Workshop\1. Introductie Git.md | bg-24.2.Git.OI<br>bg-24.3.Git.OI | HBO-i/niveau-2<br>HBO-i/niveau-3<br>Beheerproces<br>Gebruiken beheersysteem<br>Git | N/A |
