...
> [!TIP] Casus
> Stel je voor dat we een e-commerceplatform bouwen waar gebruikers producten aan hun winkelwagentje kunnen toevoegen. We willen testen of een product correct wordt toegevoegd aan het winkelwagentje en of de totale prijs goed wordt berekend.
Een klant voegt een product van €50 toe aan zijn winkelwagentje en gaat vervolgens naar de afrekenpagina. Het systeem moet het product toevoegen en de totale prijs correct bijwerken.
>
> **Testsoorten:**
>
> - **Unit test**:  
  De eerste testsoort is de unit test. Hier wordt de functie getest die verantwoordelijk is voor het toevoegen van een product aan het winkelwagentje. We controleren of de productinformatie, zoals de prijs en de naam, correct wordt toegevoegd aan het winkelwagentje.
>
> - **Integratietest**:  
  In de integratietest wordt gecontroleerd of het winkelwagentje goed samenwerkt met andere systemen, zoals de voorraadbeheer- en prijsberekeningssystemen. We testen of het systeem het product goed toevoegt aan het winkelwagentje en of de prijs correct wordt berekend, inclusief eventuele kortingen of belasting.
>
> - **Systeemtest**:  
  In de systeemtest wordt de volledige workflow getest: een klant voegt een product toe aan zijn winkelwagentje, controleert de inhoud van het winkelwagentje en ziet of de totale prijs juist wordt weergegeven. We testen de werking van het gehele e-commerceplatform om ervoor te zorgen dat de winkelwagentje-functionaliteit binnen het grotere systeem goed functioneert.
>  
> - **Acceptatietest**:  
  Tot slot wordt een acceptatietest uitgevoerd. Hier wordt getest of de klant de verwachte ervaring heeft wanneer hij het product toevoegt aan het winkelwagentje, de prijs ziet en vervolgens verder kan gaan naar de afrekenpagina. De klant of de eindgebruiker valideert of het systeem voldoet aan hun verwachtingen en bedrijfsvereisten.
> 
> In dit geval zijn de testsoorten **unit test**, **integratietest**, **systeemtest**, en **acceptatietest** van toepassing op het testen van de functionaliteit voor het toevoegen van een product aan het winkelwagentje.
...
Voor elk type testsoort zijn meerdere testvormen te kiezen. Een overzicht en beschrijving hiervan is te vinden in het [TMAP - Overzicht testvormen.pdf|overzicht van TMap].
