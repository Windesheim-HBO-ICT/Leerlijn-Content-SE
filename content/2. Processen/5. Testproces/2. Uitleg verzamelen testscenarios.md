...
De vraag bij de geselecteerde use case is: Wat moet er getest worden?   
...
Na het bestuderen van de formulering van de use case worden de **testscenario's** op een rij gezet. Het resultaat is altijd meer dan één **testscenario**. Meer dan één omdat er altijd een happy path is en een unhappy path.  
