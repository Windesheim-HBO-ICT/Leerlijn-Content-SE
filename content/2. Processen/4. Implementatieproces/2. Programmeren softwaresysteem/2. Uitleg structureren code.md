...
> [!TIP] Casus Single Responsibility  
...
## Hoe zit structureren van code in elkaar?
...
In de requirements en ontwerp fase, dus bij het opstellen van acceptatiecriteria, het nadenken over het een architectuur is het van belang stil te staan of op basis van de gegeven requirements verantwoordelijkheden duidelijk zijn en of ze niet conflicteren.
In de developement fase geldt natuurlijk dat je als developer hiermee bezig bent tijdens het programmeren. Maar het moet een vast onderdeel zijn van het reviewen van code.
...
**8. Bij het Invoeren van Refactoring**  
