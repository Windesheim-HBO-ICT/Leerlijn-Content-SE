...
```mermaid
flowchart TD
    A[REQ-04: Gebruiker kan wachtwoord wijzigen] --> B1[Ontwerp Use Case: Wijzigen wachtwoord (alleen admin)]
    B1 -.X.-> A [Mismatch: functionaliteit niet beschikbaar voor gewone gebruiker]
```
...
> Volgende stap: [[6. Controle toepassing ontwerptechnieken|Controle toepassing ontwerptechnieken]]