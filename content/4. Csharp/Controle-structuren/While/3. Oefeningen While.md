...
>   diceValue = rand.Next(1, 7); // Dobbelsteenwaarde tussen 1 en 6
>   count++;
>   Console.WriteLine($"Dobbelsteenrol {count}: {diceValue}");
> } while (diceValue != 6);
> 
> // Toon resultaat
> Console.WriteLine($"Het duurde {count} worpen om een {diceValue} te gooien.");
>```
