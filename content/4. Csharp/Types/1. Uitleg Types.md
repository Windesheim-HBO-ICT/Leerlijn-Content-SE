...
## Wat zijn types?
In programmeertalen worden kunnen variabelen bestaan in twee categorieën van types: **value types** en **reference types**. Het verschil tussen deze twee zit in hoe de gegevens worden opgeslagen en gedeeld in het geheugen.
