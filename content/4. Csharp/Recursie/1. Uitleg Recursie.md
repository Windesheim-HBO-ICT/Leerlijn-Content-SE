...
Als de functie in het bovenstaande voorbeeld wordt aangeroepen met de waarde 5, dan zal deze functie 5 keer uitgevoerd worden, doordat bij de recursieve aanroep de waarde verlaagd wordt met 1. Hier is `if(aantal >= 1)` de base case, aangezien deze ervoor zorgt dat er een einde aan de recursie is.
