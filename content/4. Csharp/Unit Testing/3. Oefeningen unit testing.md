...
> 	{ 
> 		LeeftijdChecker checker = new LeeftijdChecker(); 
> 		Assert.That(checker.IsVolwassen(25), Is.True, "25 zou een volwassene moeten zijn");
> 	} 
> }
...
> 	{ 
> 		Rekenmachine rekenmachine = new Rekenmachine();
> 		Assert.That(rekenmachine.IsEven(getal), Is.EqualTo(verwacht), $"Fout bij getal {getal}");
> 	} 
> }
