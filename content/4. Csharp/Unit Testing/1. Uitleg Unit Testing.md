...
> [!TIP] Casus 
> Een webshop heeft een methode voor het bereken van de totale prijs van een bestelling. Met unit testing kan zo'n methode gecontroleerd worden of deze na behoren werkt.
...
**Unit testing** wordt uitgevoerd met een testframework, zoals NUnit, xUnit of MSTest in C#. Dit framework draait testmethodes en rapporteert of ze slagen of falen. In Visual Studio worden deze twee frameworks aangeboden bij het aanmaken van een testproject. 
