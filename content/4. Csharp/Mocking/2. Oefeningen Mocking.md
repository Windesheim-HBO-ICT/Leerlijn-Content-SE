...
## Opdracht 5
Werken met terugkerende waarden in mocking.

### Specificaties
- Maak een mock van IWeatherService.
- De interface bevat een methode string GetWeather(string city).
- Stel in dat als de stad "Amsterdam" is, de methode "Zonnig" retourneert, en voor andere steden "Onbekend" retourneert.
- Roep de methode aan voor de stad "Amsterdam" en print het resultaat.
...
> var mockWeatherService = new Mock<IWeatherService>();  
> mockWeatherService  
>     .Setup(ws => ws.GetWeather("Amsterdam"))  
>     .Returns("Zonnig");  
> mockWeatherService  
>     .Setup(ws => ws.GetWeather(It.Is<string>(city => city != "Amsterdam")))  
>     .Returns("Onbekend");  
> 
> Console.WriteLine(mockWeatherService.Object.GetWeather("Amsterdam"));  
> 
> ```