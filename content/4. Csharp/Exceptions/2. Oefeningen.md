---
title: Oefeningen Exceptions
draft: true
tags: 
taxonomie:
  - ib-19.2.Exceptions.2.DT
  - ib-19.2.Exceptions.3.DT
---
> Meer informatie over [[1. Uitleg|Exceptions]]
...
Tip: Maak twee catch blokken. Eén voor `DivideByZeroException` en één voor een `FormatException` (als er geen getal is ingevoerd maar bijvoorbeeld een tekst).
