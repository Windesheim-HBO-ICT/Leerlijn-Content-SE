...
Bij het **declareren** geef je aan wat de naam, het type en soms ook de toegangsspecificaties ([[2. Uitleg Access-Modifiers|Access Modifiers]]) van een variabele zijn. Dit doe je door het type en vervolgens de naam aan te geven binnen de code.
