...
// todo
Geordend: De elementen worden in een vaste volgorde opgeslagen.
Index: Elk element heeft een index, meestal beginnend bij 0.
Zelfde type (meestal): In sommige programmeertalen moeten alle elementen van hetzelfde type zijn (bijv. alleen getallen of alleen tekst), terwijl andere talen mixen toestaan.
Makkelijk toegankelijk: J
