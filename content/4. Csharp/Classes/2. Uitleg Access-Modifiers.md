...
**Access modifiers** bepaalt voor een property, method of class wie er toegang tot heeft. Bij de declaratie van een property, method of class staat de **access modifier** voor aan.
