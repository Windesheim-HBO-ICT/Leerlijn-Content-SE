...
Een **class** heeft een drietal verschillende eigenschappen die het kan hebben. Een **class** heeft namelijk een, hiermee kan een object gemaakt worden van deze **class**. Een object is dan ook niks minder dan een implementatie van een **class**. Verder kunnen **classes** eigenschappen ([[2. Ondersteunende-informatie/3. Processen/4. Implementatieproces/2. Bouwen softwaresysteem/Properties/1. Properties|Properties]]) en acties ([[1. Uitleg Method|methodes]])) hebben, die respectievelijk de kenmerken en functies van de **class** beschrijven.
