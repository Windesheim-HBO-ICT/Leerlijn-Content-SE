...
> Meer informatie over [[1. Docker|Docker]]
...
1. open Docker Desktop en klik op de terminal knop rechtsonderin.
...
5. Ga terug naar de terminal en voer het volgende comando in om een container te maken van de image(de container word direct gestart):
```
docker run -p 80:80 -d ghcr.io/windesheim-hbo-ict/leertaken
```
5. De wiki is nu lokaal bereikbaar vanaf [[http://localhost/]].
