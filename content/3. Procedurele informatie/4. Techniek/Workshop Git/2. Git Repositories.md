...
tags:
---
> Meer informatie over repositories: [[content/2. Ondersteunende-informatie/4. Techniek/Git/2. Git Repositories]]\
...
- De url is op te halen door bij een repository op de `<> Code` knop te drukken en onder het tabje **HTTPS** de url te kopiëren. ![[PI_Git_Repository_Clonen.jpg]]
