...
Een propositie in de 
- Minimale = Enkelvoudig (Het regent of Het waait)
- Iets uitgebreider = Ontkenning (Het regent niet)
- Samengestelde propositie met operator (het regent of het waait, het regent en het waait niet)
...
> [!warning] Let op
> Implicatie = niet alleen Als dan, het kan ook "Als niet, dan toch"
> Zoon, huiswerk, chocola voorbeeld opnemen
